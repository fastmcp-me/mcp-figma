...
export type FrameTraits = IsLayerTrait & HasBlendModeAndOpacityTrait & HasChildrenTrait & HasLayoutTrait & HasFramePropertiesTrait & CornerTrait & HasGeometryTrait & HasExportSettingsTrait & HasEffectsTrait & HasMaskTrait & TransitionSourceTrait & IndividualStrokesTrait & DevStatusTrait & AnnotationsTrait;
export type DefaultShapeTraits = IsLayerTrait & HasBlendModeAndOpacityTrait & HasLayoutTrait & HasGeometryTrait & HasExportSettingsTrait & HasEffectsTrait & HasMaskTrait & TransitionSourceTrait;
...
} & IsLayerTrait & HasExportSettingsTrait;
...
} & IsLayerTrait & HasBlendModeAndOpacityTrait & HasChildrenTrait & HasLayoutTrait & HasGeometryTrait & HasExportSettingsTrait & HasEffectsTrait & HasMaskTrait & TransitionSourceTrait;
...
} & IsLayerTrait & HasGeometryTrait & HasChildrenTrait & HasLayoutTrait & DevStatusTrait;
...
export type ComponentNode = {
    ...
    type: "COMPONENT";
} & FrameTraits & ComponentPropertiesTrait;
...
export type VectorNode = {
    ...
    type: "VECTOR";
} & CornerRadiusShapeTraits & AnnotationsTrait;
...
export type LineNode = {
    ...
    type: "LINE";
} & DefaultShapeTraits & AnnotationsTrait;
...
export type TextNode = {
    ...
    type: "TEXT";
} & DefaultShapeTraits & TypePropertiesTrait & AnnotationsTrait;
export type TableNode = {
    /** The type of this node, represented by the string literal "TABLE" */
    type: "TABLE";
} & IsLayerTrait & HasChildrenTrait & HasLayoutTrait & MinimalStrokesTrait & HasEffectsTrait & HasBlendModeAndOpacityTrait & HasExportSettingsTrait;
export type TableCellNode = {
    /** The type of this node, represented by the string literal "TABLE_CELL" */
    type: "TABLE_CELL";
} & IsLayerTrait & MinimalFillsTrait & HasLayoutTrait & HasTextSublayerTrait;
...
} & IsLayerTrait & HasLayoutTrait & HasBlendModeAndOpacityTrait & MinimalFillsTrait & HasMaskTrait & HasEffectsTrait & HasExportSettingsTrait & HasTextSublayerTrait;
export type ShapeWithTextNode = {
    ...
    shapeType: ShapeType;
} & IsLayerTrait & HasLayoutTrait & HasBlendModeAndOpacityTrait & MinimalFillsTrait & HasMaskTrait & HasEffectsTrait & HasExportSettingsTrait & HasTextSublayerTrait & CornerTrait & MinimalStrokesTrait;
...
} & IsLayerTrait & HasLayoutTrait & HasBlendModeAndOpacityTrait & HasEffectsTrait & HasExportSettingsTrait & HasTextSublayerTrait & MinimalStrokesTrait;
...
export type WidgetNode = {
    ...
    type: "WIDGET";
} & IsLayerTrait & HasExportSettingsTrait & HasChildrenTrait;
/** An RGB color */
...
/** Connector line type. */
export declare enum ConnectorLineType {
    STRAIGHT = "STRAIGHT",
    ELBOWED = "ELBOWED"
}
...
} | OnKeyDownTrigger | OnMediaHitTrigger | {
    type: "ON_MEDIA_END";
};
...
export type Action = {
    type: "BACK" | "CLOSE";
} | OpenURLAction | UpdateMediaRuntimeAction | SetVariableAction | SetVariableModeAction | ConditionalAction | NodeAction;
...
/** Defines the types of data a VariableData object can eventually equal */
export declare enum VariableResolvedDataType {
    BOOLEAN = "BOOLEAN",
    FLOAT = "FLOAT",
    STRING = "STRING",
    COLOR = "COLOR"
...
/** Defines the list of operators available to use in an Expression. */
export declare enum ExpressionFunction {
    ADDITION = "ADDITION",
...
export declare enum WebhookV2Event {
    PING = "PING",
 ...
 */
export declare enum WebhookV2Status {
    ACTIVE = "ACTIVE",
    PAUSED = "PAUSED"
}
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    v1: {
         ...
         * @secure
         */
        getFileNodes: (fileKey: string, query: {
         ...
         * @secure
         */
        getImages: (fileKey: string, query: {
         ...
         * @secure
         */
        getImageFills: (fileKey: string, params?: RequestParams) => Promise<AxiosResponse<{
         ...
         * @secure
         */
        getTeamProjects: (teamId: string, params?: RequestParams) => Promise<AxiosResponse<{
            /** The team's name. */
            name: string;
         ...
         * @secure
         */
        getFileVersions: (fileKey: string, query?: {
            /**
         ...
         * @secure
         */
        getComments: (fileKey: string, query?: {
         ...
         * @secure
         */
        postComment: (fileKey: string, data: {
            ...
            client_meta?: Vector | FrameOffset | Region | FrameOffsetRegion;
        }, params?: RequestParams) => Promise<AxiosResponse<Comment, any>>;
        /**
         ...
         * @secure
         */
        deleteComment: (fileKey: string, commentId: string, params?: RequestParams) => Promise<AxiosResponse<{
         ...
         * @secure
         */
        getCommentReactions: (fileKey: string, commentId: string, query?: {
         ...
         * @secure
         */
        postCommentReaction: (fileKey: string, commentId: string, data: {
            /** The emoji type of reaction as shortcode (e.g. `:heart:`, `:+1::skin-tone-2:`). The list of accepted emoji shortcodes can be found in [this file](https://raw.githubusercontent.com/missive/emoji-mart/main/packages/emoji-mart-data/sets/14/native.json) under the top-level emojis and aliases fields, with optional skin tone modifiers when applicable. */
            emoji: Emoji;
        }, params?: RequestParams) => Promise<AxiosResponse<{
            /** The status of the request. */
         ...
         * @secure
         */
        deleteCommentReaction: (fileKey: string, commentId: string, query: {
            /** The emoji type of reaction as shortcode (e.g. `:heart:`, `:+1::skin-tone-2:`). The list of accepted emoji shortcodes can be found in [this file](https://raw.githubusercontent.com/missive/emoji-mart/main/packages/emoji-mart-data/sets/14/native.json) under the top-level emojis and aliases fields, with optional skin tone modifiers when applicable. */
            emoji: Emoji;
        }, params?: RequestParams) => Promise<AxiosResponse<{
            /** The status of the request. */
         ...
         * @secure
         */
        getMe: (params?: RequestParams) => Promise<AxiosResponse<User & {
         ...
         * @secure
         */
        getTeamComponents: (teamId: string, query?: {
            /**
         ...
         * @secure
         */
        getFileComponents: (fileKey: string, params?: RequestParams) => Promise<AxiosResponse<{
            /** The status of the request. */
            status: 200;
            /** For successful requests, this value is always `false`. */
            error: false;
         ...
         * @secure
         */
        getComponent: (key: string, params?: RequestParams) => Promise<AxiosResponse<{
            /** The status of the request. */
            status: 200;
            /** For successful requests, this value is always `false`. */
            error: false;
         ...
         * @secure
         */
        getTeamComponentSets: (teamId: string, query?: {
            /**
             * Number of items to return in a paged list of results. Defaults to 30.
             * @default 30
             */
         ...
         * @secure
         */
        getFileComponentSets: (fileKey: string, params?: RequestParams) => Promise<AxiosResponse<{
            /** The status of the request. */
            status: 200;
            /** For successful requests, this value is always `false`. */
            error: false;
         ...
         * @secure
         */
        getComponentSet: (key: string, params?: RequestParams) => Promise<AxiosResponse<{
            /** The status of the request. */
            status: 200;
            /** For successful requests, this value is always `false`. */
            error: false;
         ...
         * @secure
         */
        getTeamStyles: (teamId: string, query?: {
            /**
             * Number of items to return in a paged list of results. Defaults to 30.
             * @default 30
             */
         ...
         * @secure
         */
        getFileStyles: (fileKey: string, params?: RequestParams) => Promise<AxiosResponse<{
            /** The status of the request. */
            status: 200;
            /** For successful requests, this value is always `false`. */
            error: false;
         ...
         * @secure
         */
        getStyle: (key: string, params?: RequestParams) => Promise<AxiosResponse<{
            /** The status of the request. */
            status: 200;
            /** For successful requests, this value is always `false`. */
            error: false;
         ...
         * @secure
         */
        getLocalVariables: (fileKey: string, params?: RequestParams) => Promise<AxiosResponse<{
            /** The response status code. */
            status: 200;
            /** For successful requests, this value is always `false`. */
            error: false;
         ...
         * @secure
         */
        getPublishedVariables: (fileKey: string, params?: RequestParams) => Promise<AxiosResponse<{
            /** The response status code. */
            status: 200;
            /** For successful requests, this value is always `false`. */
            error: false;
         ...
         * @secure
         */
        postVariables: (fileKey: string, data: {
         ...
         * @secure
         */
        getDevResources: (fileKey: string, query?: {
         ...
         * @secure
         */
        deleteDevResource: (fileKey: string, devResourceId: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         * @secure
         */
        getLibraryAnalyticsComponentActions: (fileKey: string, query: {
         ...
         * @secure
         */
        getLibraryAnalyticsComponentUsages: (fileKey: string, query: {
            /** Cursor indicating what page of data to fetch. Obtained from prior API call. */
            cursor?: string;
            /** A dimension to group returned analytics data by. */
         ...
         * @secure
         */
        getLibraryAnalyticsStyleActions: (fileKey: string, query: {
            /** Cursor indicating what page of data to fetch. Obtained from prior API call. */
            cursor?: string;
            /** A dimension to group returned analytics data by. */
            group_by: "style" | "team";
         ...
         * @secure
         */
        getLibraryAnalyticsStyleUsages: (fileKey: string, query: {
            /** Cursor indicating what page of data to fetch. Obtained from prior API call. */
            cursor?: string;
            /** A dimension to group returned analytics data by. */
            group_by: "style" | "file";
         ...
         * @secure
         */
        getLibraryAnalyticsVariableActions: (fileKey: string, query: {
            /** Cursor indicating what page of data to fetch. Obtained from prior API call. */
            cursor?: string;
            /** A dimension to group returned analytics data by. */
         ...
         * @secure
         */
        getLibraryAnalyticsVariableUsages: (fileKey: string, query: {
            /** Cursor indicating what page of data to fetch. Obtained from prior API call. */
            cursor?: string;
            /** A dimension to group returned analytics data by. */
    ...
    v2: {
        ...
        postWebhook: (data: {
            ...
            description?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<WebhookV2, any>>;
        /**
         ...
         * @secure
         */
        getWebhook: (webhookId: string, params?: RequestParams) => Promise<AxiosResponse<WebhookV2, any>>;
        /**
         ...
         * @secure
         */
        putWebhook: (webhookId: string, data: {
            /** An enum representing the possible events that a webhook can subscribe to */
            event_type: WebhookV2Event;
            /** The HTTP endpoint that will receive a POST request when the event triggers. Max length 2048 characters. */
            endpoint: string;
         ...
         * @secure
         */
        deleteWebhook: (webhookId: string, params?: RequestParams) => Promise<AxiosResponse<WebhookV2, any>>;
        /**
         ...
         * @secure
         */
        getTeamWebhooks: (teamId: string, params?: RequestParams) => Promise<AxiosResponse<{
         ...
         * @secure
         */
        getWebhookRequests: (webhookId: string, params?: RequestParams) => Promise<AxiosResponse<{
